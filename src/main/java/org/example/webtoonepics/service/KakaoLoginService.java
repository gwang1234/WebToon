...
public class KakaoLoginService {
    ...
    public String getAccessToken(String code) {
        ...
        KakaoTokenResponseDto tokenResponse = webClientBuilder.build()
                ...
                .body(BodyInserters.fromFormData("grant_type", grantType)
                        ...
                        .with("code", code))
                .retrieve() // 요청 실행
                .onStatus(HttpStatusCode::is4xxClientError, clientResponse -> Mono.error(new KakaoTokenRequestException("Invalid authorization code or parameters")))
                .onStatus(HttpStatusCode::is5xxServerError, clientResponse -> Mono.error(new KakaoServerException("Kakao server error")))
    ...
    public KakaoUserInfoResponseDto getUserInfo(String accessToken) {
        ...
        KakaoUserInfoResponseDto userInfo = webClientBuilder.build()
                ...
                .retrieve() // 요청 실행
                .onStatus(HttpStatusCode::is4xxClientError, clientResponse -> Mono.error(new KaKaoUserInfoRequestException("Invalid Access Token")))
                .onStatus(HttpStatusCode::is5xxServerError, clientResponse -> Mono.error(new KakaoServerException("Kakao server error")))
