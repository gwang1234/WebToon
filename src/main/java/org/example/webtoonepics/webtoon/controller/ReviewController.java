...
public class ReviewController {
    ...
    public ResponseEntity<Review> writeReview(@PathVariable(name = "id") Long id, @RequestBody ReviewRequest reviewRequest) {
        Review writeReview = reviewService.save(id, reviewRequest);
