...
public class MainController {
    ...
    public Page<MainWebtoonDto> likes(@RequestParam(value = "page", defaultValue = "0")int page) {
    ...
    public Page<MainWebtoonDto> views(@RequestParam(value = "page", defaultValue = "0")int page) {
