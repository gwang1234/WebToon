// components/ClientLayout.tsx (클라이언트 컴포넌트로 분리)
"use client"; // 클라이언트 컴포넌트로 설정

import { useState, useEffect } from "react";
import { usePathname, useSearchParams } from "next/navigation"; // next/navigation에서 경로 감지 훅 사용
...
export default function ClientLayout({
  ...
  }, [pathname, searchParams]); // 경로 또는 쿼리 변경을 감지
